...
## Source
As I already mentionned in the paragrah above, my primary source of inspiration is this [video](https://youtu.be/1-3_ecWMCYI?si=Rvj_1F8Deu94mCbc) and the associated [github](https://github.com/NischalDawadi/Hyprlust/).
For the wallpapers I used this [repository](https://github.com/NischalDawadi/Wallpapers).
Many thanks to [NischalDawadi](https://github.com/NischalDawadi) for the repositories.
